<div class="story"><div class="story-head">Where do I fit?</div>
<div class="pic-area"><img src="/img/me.png" id="my-pic"></div>
<p>On websites I tend to be more oriented towards backend but I can perform as a full stack developer. Problems behind the scenes usually interest me more and my visual creativity rarely ventures outside of "simple".
On native mobile I have some experience with Android Studio, but almost no experience with XCode. I would really love to get into lower level tool development with C++, C#, or Java. I've never experienced these 
on a professional level, but could acclimate quickly with some preparation.</p>
<p>On a team I believe in open mindedness, open communication, and treating every day like a learning experience. The team should be in a constant state of bettering each other 
and building solid skill sets that will benefit future work.</p>
Technical Skills
<ul>
  <li>Amazon Web Services</li>
  <li>SQL Databases</li>
  <li>Ruby, Node, Javascript, CSS</li>
</ul>
Adaptable Skills
<ul>
  <li>PHP, Python</li>
...
Though I wasn't actively studying code concepts at age 10 I would regularly be playing a game and wondering "How does this work? What's this code look like?"
...
<p>Fast forward to me at 30 years old. I'm a father of 2 and I have pretty much been working in whatever local job I could find. Sometimes fixing people's computers or phones
...
He had met someone at a local restaurant hanging up flyers for a coding bootcamp. Their main focus was to re-train interested laid off coal miners to code, though this wasn't a requirement.
It seemed too good to be true: completely free, go at your own pace, and they were even offering jobs to anyone who could complete the bootcamp. My friend knew how much I wanted to do this for a career and
...
A few months later I had my first actual job as a contracted programmer!</p>
...
<p>Around the time I was let go my father got sick and i went back to my previous job for stability.
...
<p>An individual can do something great, but a team can do something amazing!</p>
</div>